...
This plugin can use subtables of kintone.

== Description ==

This plugin is Add-on of "Form data to kintone".
This plugin can use subtables of kintone.
This plugin requires "form-data-to-kintone plugin" and "Contact Form 7 - Repeatable Fields plugin".
...
== Changelog ==
* 1.0.1 - Change KintoneForm to Kintone_Form_Post_Kintone.
* 1.0.0 - First Release
